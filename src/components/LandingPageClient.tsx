          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch w-full">
            {plans.map((plan) => (
              ...
              >
                {/* Highlight Badge */}
                {plan.badge && (
                  <span className="absolute top-4 right-4 text-[8px] font-extrabold uppercase tracking-widest px-2.5 py-1 rounded-full bg-zinc-955 text-white border border-zinc-900">
                    {plan.badge}
                  </span>
                )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="p-6 bg-zinc-50 border border-zinc-200/50 rounded-3xl flex flex-col justify-between text-left">
                ...
                <div className="mt-6">
                  <span className="font-bold text-xs text-zinc-955 block">{t.author}</span>
